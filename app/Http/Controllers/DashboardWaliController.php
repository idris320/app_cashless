...
class DashboardWaliController extends Controller
{
    ...
    {
        return view('dashboardwali.dashboardwali');
    }
     ...
     */
    public function edit(DashboardWali $dashboardWali)
    {
        //
    }
     ...
     */
    public function update(Request $request, DashboardWali $dashboardWali)
    {
        //
    }
