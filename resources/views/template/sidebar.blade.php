...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        <a href="{{ route('dashboard') }}" class="navbar-brand mx-4 mb-3">
            <h3 class="text-success"><i class="fa fa-hashtag me-2"></i>AL-FURQON</h3>
        </a>
        <div class="d-flex align-items-center ms-4 mb-4">
            <div class="position-relative">
                <img class="rounded-circle" src="{{ asset('image/user.png') }}" alt="" style="width: 40px; height: 40px;">
        ...
        <div class="navbar-nav w-100">            
            ...
            <a href="{{ route('barang.index') }}" class="nav-item nav-link">
                <i class="fa fa-box-open me-2"></i>Barang
            </a>            
